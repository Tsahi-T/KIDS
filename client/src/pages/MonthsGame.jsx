...
import { generateMonthQuestion } from '../utils/months.js'
...
export default function MonthsGame({ player, onGameOver }) {
  ...
  return (
    <div className="eng-screen">
      ...
      <div className="num-display-wrap">
        <div className={`num-big${urgent ? ' urgent-word' : ''}`}>{question.prompt}</div>
        ...
        {question.answers.map((ans, i) => {
          ...
          return (
            <button key={i}
              ...
              style={{ background: state ? undefined : ANS_COLORS[i], fontSize: '0.85rem' }}
